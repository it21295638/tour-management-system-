...
import Guide from "../pages/admin/guideManagemnt/addGuide";
import GuideMngmnt from "../pages/admin/guideManagemnt/editGuide";
                    ...
                    <Route path='/admin/:path?' exact>
                        <AdminLayout class="wrapper">
                            ...
                            <Switch>
                                ...
                                {/* Guide managemnt */}
                                <Route path="/admin/guide" render={(props) => <Guide/>}/>;
                                <Route path="/admin/guideedit" render={(props) => <GuideMngmnt/>}/>;
